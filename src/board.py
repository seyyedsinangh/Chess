    ...
    def __str__(self):
        ...
        for row in range(8):
            ...
            for col in range(8):
                ...
                if piece:
                    # Append piece symbol and color initial
                    piece_symbol = piece.__class__.__name__[0]  # First letter of the class name
                    piece_color_initial = piece.color[0].upper()  # First letter of the color, capitalized
                    board_str += f'{piece_color_initial}{piece_symbol} '
                else:
                    # Append dot for empty squares
                    board_str += '. '
